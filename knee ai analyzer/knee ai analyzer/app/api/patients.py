...
@router.delete(
    ...
    summary="Clear all patients",
    description="Safely delete all patient records and associated scan records and physical scan files.",
)
def clear_all_patients(
    db: Session = Depends(get_db)
):
    """Delete all patient records and associated scans."""
    patient_service.clear_all_patients(db)
    return {"message": "All patient records cleared successfully"}
