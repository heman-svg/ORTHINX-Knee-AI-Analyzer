...
export const Sidebar: React.FC = () => {
  const navItems = [
    ...
    { label: "Knee Analysis", path: "/knee-analysis", icon: Activity },
    { label: "Meniscus Analysis", path: "/meniscus-analysis", icon: Layers },
    { label: "Anatomical Measurements", path: "/anatomical-measurements", icon: Ruler },
